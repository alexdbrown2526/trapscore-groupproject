...
--creates events for competitions with ids of 1, 2, and 3
INSERT INTO "event" ("name", "competition_id")
VALUES ('Singles', 1), ('Doubles', 1), ('Handicap', 1), ('Singles', 2), ('Doubles', 2), ('Handicap', 2), ('Singles', 3), ('Doubles', 3), ('Handicap', 3);

--links some random shooters to events
INSERT INTO "shooter_event" ("event_id", "shooter_id")
VALUES (1, 2), (1, 7), (3, 28), (2, 45), (5, 32), (4, 57), (8, 4), (9, 88), (7, 88);
...
--use for /shooters route
--select all shooters from a single competition by competition id (later needs squads and events added)
SELECT "shooter"."id", "shooter"."first_name", "shooter"."last_name", "shooter"."email", "shooter"."phone", "shooter"."handicap", "shooter"."ata_number" FROM "shooter"
JOIN "shooter_event" on "shooter"."id" = "shooter_event"."shooter_id"
JOIN "event" ON "shooter_event"."event_id" = "event"."id"
JOIN "competition" ON "competition"."id" = "event"."competition_id"
